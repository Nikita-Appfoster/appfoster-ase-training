...
<html lang="en">
  ...
  <body>
    ...
    <div class="d-flex justify-content-end">
        <a href= "{{ route('projectlist', $user->id) }}" class="btn btn-dark btn-sm active mt-3" role="button" aria-pressed="true" style="margin-right: 160px;">Back</a>
    </div>
    ...
    <div class="d-flex justify-content-center align-items-center">
        <div class="container">
            ...
            <div class="d-flex justify-content-center mt-2">
                <form style="width: 50%" action="{{route('addprojects' , $user->id)}}" method="POST">
                    @csrf
